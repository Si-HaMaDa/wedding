...
<body class="rtl">
      ...
      <!--div class="color-switcher" id="choose_color">
         <a href="{{url('frontend')}}/#." class="picker_close"><i class="fa fa-gear"></i></a>
                           ...
                           <li class="dropdown">
                              ...
                              <li></li>
                               <li></li>
                                 ...
                                 <li><a href="archives">أرشيف</a></li>
                                 <li><a href="{{url('userads')}}">إعلانات نشطة</a></li>
                                 <li><a href="favourite.html">إعلانات المفضلة</a></li>
                                 <li><a href="{{url('profile')}}">ملف تعريفي للمستخدم</a></li>
                                 <li><a href="messages">لوحة رسالة</a></li>
                                 <li><a href="">التعطيل حساب</a></li>
                              </ul>
                           </li>
                        </ul>
                     </div>
                  ...
                  <div class="container">
                     <div class="row">
                        <div class="col-lg-12 col-md-12">
                           ...
                           <ul class="menu-logo">
                              <li>
                                 <a href="{{url('wedding')}}"><img src="{{url('frontend')}}/images/logo-1.png" alt="logo"> </a>
                              </li>
                           </ul>
                           <!-- menu links -->
                           <ul class="menu-links">
