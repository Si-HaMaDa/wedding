         ...
         <div class="container">
            <div class=" breadcrumb-link">
               <ul>
                  ...
                  <li><a class="active" href="#">الرسائل</a></li>
               </ul>
            </div>
         </div>
      </div>
                           ...
                           <ul class="message-history">
                              ...
                              <li class="message-grid">
                                 <a href="#">
                                    ...
                                    <div class="user-name">
                                       <div class="author">
                                          <span>سونو مونو</span><div class="user-status"></div>
                                       </div>
                                       <p>Xperia z5 for sale</p>
                                       <div class="time">
                     ...
                     <div class="col-md-8 clearfix col-sm-5 col-xs-12 message-content">
                        <div class="message-details">
                           <div class="author">
                              ...
                              <span class="author-name">سونو مونو</span>
                              <em>5 days ago</em>
                           </div>
                           <h2>سوني Xperia Z5 For Sale</h2>
                           <ul class="messages">
                              ...
                              <li class="my-message clearfix">
                                 <figure class="profile-picture">
                                    <img src="images/users/2.jpg" class="img-circle" alt="الملف الشخصي Pic">
                                 </figure>
                                 <div class="message">
